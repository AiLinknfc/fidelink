  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-4">
      <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
        <Palette className="w-5 h-5" style={{ color: brand.colorHex }} />
      ...
      <div className="p-2.5 rounded-xl bg-slate-50 border border-dashed border-slate-300 space-y-1.5">
        ...
        <label className="block">
          ...
          <div className="py-1.5 px-3 bg-white hover:bg-slate-100 rounded-lg border border-slate-200 text-center cursor-pointer transition-colors">
            <span className="text-[9px] font-bold" style={{ color: brand.colorHex }}>Seleccionar archivo JSON</span>
          </div>
        </label>
      </div>
        ...
        <div className="flex flex-wrap gap-1">
          {FONTS_LIST.map((font) => (
            <button
              ...
              style={currentStyle.fontStyle === font.id ? { borderColor: brand.colorHex, backgroundColor: `${brand.colorHex}12` } : undefined}
              title={font.preview}
            >
              {font.label}
            </button>
          ...
          {CARD_STYLES.map((style) => {
            ...
            return (
              <button
                ...
                style={selected ? { borderColor: brand.colorHex, backgroundColor: `${brand.colorHex}0D`, boxShadow: `0 0 0 1px ${brand.colorHex}40` } : undefined}
                title={style.label}
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  {selected && <Check className="w-2 h-2 shrink-0" style={{ color: brand.colorHex }} />}
                </div>
              </button>
            );
          })}
        ...
        <div className="space-y-3">
            ...
            {BACKGROUND_WALLPAPERS.map((wall) => {
              ...
              return (
                <button
                  ...
                  style={isSelected ? { borderColor: brand.colorHex, boxShadow: `0 0 0 2px ${brand.colorHex}40` } : undefined}
                >
                  ...
                  {isSelected && <Check className="w-3 h-3 flex-shrink-0" style={{ color: brand.colorHex }} />}
                </button>
              );
            })}
          </div>
          ...
          <div className="p-2.5 rounded-xl border border-slate-200 bg-slate-50/50 space-y-2">
            <div className="flex items-center gap-2">
              <Paintbrush className="w-3.5 h-3.5" style={{ color: brand.colorHex }} />
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded" style={{ color: brand.colorHex, '--tw-ring-color': brand.colorHex } as React.CSSProperties}
            />
      ...
      {onPublish && (
        <button
          onClick={onPublish}
          className="w-full py-3 px-4 text-white rounded-xl font-bold text-sm transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg hover:opacity-90" style={{ backgroundColor: brand.colorHex, boxShadow: `0 10px 15px -3px ${brand.colorHex}40` }}
        >
