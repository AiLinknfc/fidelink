...
import { Users, Search, UserCheck, CreditCard } from 'lucide-react';
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between px-1">
                    <div className="min-w-0">
                      <p
                        className="font-semibold truncate text-[12px] transition-colors duration-300"
                    ...
                    <div className="flex items-center gap-2 shrink-0 ml-2">
                      {isComplete && (
                        <span
                          className="text-[10px] font-bold px-2 py-0.5 rounded-full border transition-colors duration-300"
                          style={isHovered ? {
