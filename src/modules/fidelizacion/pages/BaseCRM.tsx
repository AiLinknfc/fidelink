...
import { Users, Search, Mail, Phone, Calendar, ArrowRight, ShieldCheck, Gift, UserPlus, X, Check, Loader2 } from 'lucide-react';
...
export default function BaseCRM() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-8 py-6 space-y-6">
      <SectionRibbon
        icon={Users}
        title="Directorio de Clientes Unificado & CRM"
        description="Gestión centralizada de clientes, puntos y referidos"
      />
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-slate-50 text-slate-500 font-semibold uppercase tracking-wider text-[10px]">
                    ...
                    <th className="text-left px-4 py-3 font-mono">Rango / Antigüedad</th>
                  ...
                  {filtered.map(c => (
                    <tr key={c.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-right">
                        <span className="text-sm font-bold text-violet-600">{c.pointsTotal}</span>
                      </td>
                      <td className="px-4 py-3 text-right">
        ...
        <aside className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm space-y-3">
            <div className="flex items-center gap-2 text-blue-600">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider font-mono">Registrar Cliente CRM</span>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm space-y-3">
            <div className="flex items-center gap-2 text-blue-600">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider font-mono">Programa de Recomendaciones</span>
            </div>
            {referrals.length === 0 ? (
          ...
          {/* Shield info */}
          <div className="bg-gradient-to-br from-violet-50 to-blue-50 rounded-2xl border border-violet-200 p-4">
            <div className="flex items-center gap-2 mb-2">
              <ShieldCheck className="w-4 h-4 text-violet-600" />
              <span className="text-[10px] font-bold text-violet-700 uppercase tracking-wider font-mono">CRM Unificado</span>
            </div>
